...
date: 2026-04-19
draft: true
description: Thinking through what AI means for writing, design, and everything in between.
tags:
  - AI
  - Productivity
  - Opinion
...
If you're following AI at all you know that the hype is palpable online and in the media these days. And with it that magical quality that makes it seem like it's going to solve all the problems, at the click of a button, or a prompt tethered to a monthly subscription in this case.

The problem is that for all it's incredible capabilities AI isn't good at everything. There's a time and a place to use it. This is a lesson that those of us who've ever paid a bill for API tokens have already begun to learn. Depending on the complexity of the task and the model, you could quickly end up spending hundreds, or even thousands of dollars on tokens.
...
First, let's address the elephant in the room. What's AI actually good for when it comes to automation? AI is frighteningly good at producing certain types of content, and by exposing it to tools we can give it the ability to create and build useful things at scale. This *is* a type of automation, and seems like a miracle compared to the way we did this just a few short years ago.
